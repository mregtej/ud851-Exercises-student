...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        try {
            partySize = Integer.parseInt(mNewPartySizeEditText.getText().toString(), 1);
    ...
    private void addGuest(String name, int party_size) {
        ...
        guest.put(WaitlistContract.WaitlistEntry.COLUMN_PARTY_SIZE, party_size);
